...
npx --yes wise-statements export -k private.pem -t csv -o "./attachments/${STATEMENTS_FILE_NAME}.csv"
echo
npx --yes wise-statements export -k private.pem -t pdf -o "./attachments/${STATEMENTS_FILE_NAME}.pdf"
echo
